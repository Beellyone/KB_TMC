...
class TmcCategory(TimestampMixin, Base):
    ...
    breakdowns: Mapped[list["CategoryBreakdown"]] = relationship(
...
class CategoryBreakdown(TimestampMixin, Base):
    ...
    category: Mapped[TmcCategory] = relationship(back_populates="breakdowns")
